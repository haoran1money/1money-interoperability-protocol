...
interface IOMInterop {
    ...
    event OMInteropReceived(
        uint64 nonce, address indexed to, uint256 amount, address indexed omToken, uint32 srcChainId
    );
    ...
    function mapTokenAddresses(address omToken, address scToken, InteropProtocol interopProtoId) external;
